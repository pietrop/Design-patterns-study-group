...
You can use ArgoUML as a free software to create UML class diagrams \([http://argouml.tigris.org/\](http://argouml.tigris.org/%29\) or give a look at this list [https://en.wikipedia.org/wiki/List\_of\_Unified\_Modeling\_Language\_tools](https://en.wikipedia.org/wiki/List_of_Unified_Modeling_Language_tools)
