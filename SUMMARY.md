...
* [How to use a design pattern](how-to-use-a-design-pattern.md)
...
* [The Flyweight Pattern](structural-design-patterns/the-flyweight-pattern.md)
* [The Proxy Pattern](structural-design-patterns/the-proxy-pattern.md)

## Behavioral Design Patterns

* [The Chain of Responsibility Pattern](behavioral-design-patterns/the-chain-of-responsibility-pattern.md)
* [The Command Pattern](behavioral-design-patterns/the-command-pattern.md)
* [The Interpreter Pattern](behavioral-design-patterns/the-interpreter-pattern.md)
...
* [The Observer Pattern ](behavioral-design-patterns/the-observer-pattern.md)
* [The Publishers + Subscriber](behavioral-design-patterns/the-publishers-+-subscriber.md)
...
* [The Revealing Module Pattern](further-design-pattern-for-js/the-revealing-module-pattern.md)
* [The Mixin Pattern](further-design-pattern-for-js/the-mixin-pattern.md)
* [The Lazy Initialization Pattern](further-design-pattern-for-js/the-lazy-initialization-pattern.md)
* [The Namespacing Patterns](further-design-pattern-for-js/the-namespacing-patterns.md)
* [The Reactor Pattern](further-design-pattern-for-js/the-reactor-pattern.md)
* [The Callback Pattern](further-design-pattern-for-js/the-callback-pattern.md)
...
* [Common JS Design Patterns](https://carldanley.com/js-module-pattern)
